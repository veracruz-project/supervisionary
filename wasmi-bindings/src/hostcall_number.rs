...
pub(crate) const ABI_THEOREM_IS_REGISTERED_INDEX: usize = 57;

/// The index of the `Theorem.Register.Assumption` ABI call.
pub(crate) const ABI_THEOREM_REGISTER_ASSUMPTION_INDEX: usize = 58;

/// The index of the `Theorem.Register.Reflexivity` ABI call.
pub(crate) const ABI_THEOREM_REGISTER_REFLEXIVITY_INDEX: usize = 59;
/// The index of the `Theorem.Register.Symmetry` ABI call.
pub(crate) const ABI_THEOREM_REGISTER_SYMMETRY_INDEX: usize = 60;
/// The index of the `Theorem.Register.Transitivity` ABI call.
pub(crate) const ABI_THEOREM_REGISTER_TRANSITIVITY_INDEX: usize = 61;
/// The index of the `Theorem.Register.Beta` ABI call.
pub(crate) const ABI_THEOREM_REGISTER_BETA_INDEX: usize = 62;
/// The index of the `Theorem.Register.Eta` ABI call.
pub(crate) const ABI_THEOREM_REGISTER_ETA_INDEX: usize = 63;
/// The index of the `Theorem.Register.Application` ABI call.
pub(crate) const ABI_THEOREM_REGISTER_APPLICATION_INDEX: usize = 64;
/// The index of the `Theorem.Register.Lambda` ABI call.
pub(crate) const ABI_THEOREM_REGISTER_LAMBDA_INDEX: usize = 65;

/// The index of the `Theorem.Register.Substitution` ABI call.
pub(crate) const ABI_THEOREM_REGISTER_SUBSTITUTION_INDEX: usize = 66;
/// The index of the `Theorem.Register.TypeSubstitution` ABI call.
pub(crate) const ABI_THEOREM_REGISTER_TYPE_SUBSTITUTION_INDEX: usize = 67;

/// The index of the `Theorem.Register.TruthIntroduction` ABI call.
pub(crate) const ABI_THEOREM_REGISTER_TRUTH_INTRODUCTION_INDEX: usize = 68;
/// The index of the `Theorem.Register.FalsityElimination` ABI call.
pub(crate) const ABI_THEOREM_REGISTER_FALSITY_ELIMINATION_INDEX: usize = 69;
...
pub(crate) const ABI_THEOREM_REGISTER_DISJUNCTION_ELIMINATION_INDEX: usize = 73;
...
pub(crate) const ABI_THEOREM_REGISTER_IMPLICATION_ELIMINATION_INDEX: usize = 77;

/// The index of the `Theorem.Register.IffIntroduction` ABI call.
pub(crate) const ABI_THEOREM_REGISTER_IFF_INTRODUCTION_INDEX: usize = 78;
/// The index of the `Theorem.Register.IffLeftElimination` ABI call.
pub(crate) const ABI_THEOREM_REGISTER_IFF_LEFT_ELIMINATION_INDEX: usize = 79;

/// The index of the `Theorem.Register.NegationIntroduction` ABI call.
pub(crate) const ABI_THEOREM_REGISTER_NEGATION_INTRODUCTION_INDEX: usize = 80;
/// The index of the `Theorem.Register.NegationElimination` ABI call.
pub(crate) const ABI_THEOREM_REGISTER_NEGATION_ELIMINATION_INDEX: usize = 81;

/// The index of the `Theorem.Register.ForallIntroduction` ABI call.
pub(crate) const ABI_THEOREM_REGISTER_FORALL_INTRODUCTION_INDEX: usize = 82;
/// The index of the `Theorem.Register.ForallElimination` ABI call.
pub(crate) const ABI_THEOREM_REGISTER_FORALL_ELIMINATION_INDEX: usize = 83;
/// The index of the `Theorem.Register.ExistsIntroduction` ABI call.
pub(crate) const ABI_THEOREM_REGISTER_EXISTS_INTRODUCTION_INDEX: usize = 84;
/// The index of the `Theorem.Register.ExistsElimination` ABI call.
pub(crate) const ABI_THEOREM_REGISTER_EXISTS_ELIMINATION_INDEX: usize = 85;

/// The index of the `Theorem.Split.Hypotheses` ABI call.
pub(crate) const ABI_THEOREM_SPLIT_HYPOTHESES_INDEX: usize = 86;
/// The index of the `Theorem.Split.Conclusion` ABI call.
pub(crate) const ABI_THEOREM_SPLIT_CONCLUSION_INDEX: usize = 87;
