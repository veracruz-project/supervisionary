...
This strategy---introduced by Milner in his LCF proof assistant~\cite{Milner1972LogicFC}---is a reliability mechanism, aiming to ensure that any purported theorem produced by the system is indeed a legitimate entailment from the theory within the logic.
